...
import { makeEdgeTwinkles } from './stars.js';
...
export function renderCard(card, { isNew = false, count = 0 } = {}) {
  ...
  /* RUBY keeps five subtle side points as part of its physical finish. UR now
     uses RUBY's restrained scattered field instead, attached by each surface,
     so it does not mix two different sparkle systems. */
